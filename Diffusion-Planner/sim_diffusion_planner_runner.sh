...
export NUPLAN_DEVKIT_ROOT="$HOME/V0.1-diffusion-es/nuplan-devkit"  # nuplan-devkit absolute path (e.g., "/home/user/nuplan-devkit")
export NUPLAN_DATA_ROOT="$HOME/data1/nuplan-v1.1/splits/mini"  # nuplan dataset absolute path (e.g. "/data")
export NUPLAN_MAPS_ROOT="$HOME/data1/maps" # nuplan maps absolute path (e.g. "/data/nuplan-v1.1/maps")
export NUPLAN_EXP_ROOT="$HOME/data1/experiments" # nuplan experiment absolute path (e.g. "/data/nuplan-v1.1/exp")
